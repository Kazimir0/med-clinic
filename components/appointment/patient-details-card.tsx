    ...
    return (
        <Card className="shadow-none bg-white">
            <CardHeader>
                ...
                <div className="relative size-20xl:size-24 rounded-full overflow-hidden">
                    <Image
                ...
                <div>
                    <h2 className="text-lg font-semibold">{data?.first_name} {data?.last_name}</h2>
            ...
            <CardContent className="mt-4 space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-base font-medium text-muted-foreground">{format(new Date(data?.date_of_birth), "MMMM dd, yyyy")}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-base font-medium text-muted-foreground">Dr Catalin</p>
                    </div>
                </div>
                 ...
                 <div className="flex items-start gap-3">
                    <div>
                        ...
                        <p className="text-base font-medium text-muted-foreground">{data?.medical_conditions}</p>
                    </div>
                </div>
