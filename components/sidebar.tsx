...
import { Bell, LayoutDashboard, List, ListOrdered, LogOutIcon, Logs, LucideIcon, Pill, Receipt, Settings, SquareActivity, User, UserRound, Users, UsersRound } from 'lucide-react'
        ...
        <div className='w-full p-4 flex flex-col justify-between gap-4 bg-white overflow-y-scroll min-h-full'>
            <div className=''>
                <div className='flex items-center justify-center lg:justify-start gap-2'>
                    ...
                    <Link href={"/"} className='hidden lg:flex text-base 2xl:text-xl font-bold'>MedClinic</Link>
                </div>
