          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-16">
              <div className="flex gap-1 w-full md:w-1/2">
                ...
                <div className="space-y-0.5">
                    <h2 className="text-lg md:text-xl font-semibold uppercase">{data?.patient?.first_name + " " + data?.patient?.last_name}</h2>
            ...
            <div className="grid grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">{format(data?.appointment_date, "MMMM dd, yyyy")}</p>
                </div>
                {/* 2 */}
                <div>
