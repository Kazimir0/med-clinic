    ...
    try {
        ...
        const [data, totalRecord] = await Promise.all([
            db.appointment.findMany({
                ...
                take: LIMIT,
                select: {
                    id: true, patient_id: true, doctor_id: true,
                    type: true, appointment_date: true, time: true, status: true,
                    patient: {
        ...
        return { success: true, data, totalPages, totalRecord, currentPage: PAGE_NUMBER, status: 200 };
